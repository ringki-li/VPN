...
async function 生成随机IP(request, count = 16, 指定端口 = -1, TLS = true) {
	// 全球各国 PROXYIP 有效公共节点\uff0c每个对应真实出口国家
	const PROXY池 = [
		{ ip: '8.222.185.236', 名: '🇸🇬 新加坡' },
		{ ip: '8.209.108.202', 名: '🇯🇵 日本' },
		{ ip: '8.213.128.150', 名: '🇰🇷 韩国' },
		{ ip: '47.74.0.113', 名: '🇦🇺 法洲' },
		{ ip: '8.208.9.190', 名: '🇮🇳 印度' },
		{ ip: '47.254.33.195', 名: '🇩🇪 德国' },
		{ ip: '8.209.220.1', 名: '🇬🇧 英国' },
		{ ip: '47.251.43.45', 名: '🇺🇸 美国' },
		{ ip: '8.210.157.1', 名: '🇭🇰 香港' },
		{ ip: '47.245.54.240', 名: '🇹🇼 台湾' },
		{ ip: '8.209.255.134', 名: '🇫🇷 法国' },
		{ ip: '47.74.100.1', 名: '🇳🇱 荷兰' },
		{ ip: '8.209.194.1', 名: '🇮🇹 意大利' },
		{ ip: '47.245.120.135', 名: '🇨🇦 加拿大' },
		{ ip: '8.210.193.132', 名: '🇧🇷 巴西' },
		{ ip: '47.254.129.56', 名: '🇷🇺 俄罗斯' },
		{ ip: '8.209.105.239', 名: '🇲🇾 马来西亚' },
		{ ip: '47.74.55.1', 名: '🇵🇭 菲律宾' },
		{ ip: '8.208.77.171', 名: '🇹🇭 泰国' },
		{ ip: '47.246.10.1', 名: '🇹🇷 土耳其' },
	];
	...
	const randomIPs = Array.from({ length: count }, (_, index) => {
		const proxy = PROXY池[index % PROXY池.length];
		const 目标端口 = 指定端口 === -1
			? cfport[Math.floor(Math.random() * cfport.length)]
			: (TLS ? 指定端口 : (NOTLS端口[TLS端口.indexOf(Number(指定端口))] ?? 指定端口));
		国家计数[proxy.名] = (国家计数[proxy.名] || 0) + 1;
		return `${proxy.ip}:${目标端口}#${proxy.名} ${String(国家计数[proxy.名]).padStart(2, '0')}`;
	});
